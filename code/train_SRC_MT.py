...
parser.add_argument('--csv_file_train', type=str, default="./test_code_of_cifar10/data/cifar_10/cifar10_training.csv", help='training set csv file')
...
parser.add_argument('--csv_file_test', type=str, default="./test_code_of_cifar10/data/cifar_10/cifar10_testing.csv", help='testing set csv file')
...
if __name__ == "__main__":
    ...
    base_dataset = datasets.CIFAR10("D:/Dataset_01/cifar_10", train=True, download=False)
